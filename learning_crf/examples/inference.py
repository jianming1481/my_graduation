...
# In my research, background is black and also is a label
# And in this code black means unknow label
# So try to convert it
for i in range(anno_lbl.shape[0]):
    for j in range(anno_lbl.shape[1]):
        if anno_lbl[i][j] == 0:
            anno_lbl[i][j] = 1
