...
void ObjEstAction::estimate_object_pose(PCT::Ptr object_cloud)
{
  ...
  pcl::console::print_highlight ("Goal Label = %d...\n",goal_label);
  switch(goal_label)
  {
    case 1:
	  pcl::console::print_highlight ("Loadin Handweight_model...\n");
	  pcl::io::loadPCDFile<PointNT> ("/home/iclab/graduation_ws/src/my_graduation/object_pose_estimation/pcd_file/model/Hand_Weight.pcd", *object);
	  break;
    case 2:
	  pcl::console::print_highlight ("Loadin Crayons...\n");
	  pcl::io::loadPCDFile<PointNT> ("/home/iclab/graduation_ws/src/my_graduation/object_pose_estimation/pcd_file/model/Crayons.pcd", *object);
	  break;
    case 5:
	  pcl::console::print_highlight ("Loadin Robots_Everywhere...\n");
	  pcl::io::loadPCDFile<PointNT> ("/home/iclab/graduation_ws/src/my_graduation/object_pose_estimation/pcd_file/model/Robots_Everywhere.pcd", *object);
	  break;
   default:
	  break;
  }
